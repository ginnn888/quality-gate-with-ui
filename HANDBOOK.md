...
> [!TIP]
> เจอ error แบบนี้ตอนใช้งานจริง? **Sign out แล้ว sign in ใหม่ครั้งเดียวก็พอ** ไม่ต้อง revoke สิทธิ์ที่ GitHub ก่อน
...
> [!WARNING]
> **จุดอ่อนที่รู้อยู่** — logic นี้เชื่อ comment **ตัวสุดท้าย** ที่มีข้อความ marker โดยไม่เช็คว่าใครเป็นคนโพสต์ ถ้ามีคนพิมพ์ข้อความเดียวกันเข้าไปเองใน PR (ไม่ใช่บอท) หน้าเว็บจะเข้าใจผิดว่านั่นคือรายงานจริง — ยังไม่ได้แก้ (ดูหัวข้อ 14)
